...
indicator_map(eie, "1", beneficiaries) + 
  ...
  labs(title = "Total reached", 
       fill = "Reached") +
  plot_annotation(title = "1. Access ECD spaces/schools, target and reached", 
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "1")) %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "1")) %>% {sum(.$boys, na.rm = TRUE)} %>% format(big.mark = ",")` were boys and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "1")) %>% {sum(.$girls, na.rm = TRUE)} %>% format(big.mark = ",")` were girls.
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "2")) %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "2")) %>% {sum(.$boys, na.rm = TRUE)} %>% format(big.mark = ",")` were boys and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "2")) %>% {sum(.$girls, na.rm = TRUE)} %>% format(big.mark = ",")` were girls. 
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "3")) %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "3")) %>% {sum(.$boys, na.rm = TRUE)} %>% format(big.mark = ",")` were boys,  `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "3")) %>% {sum(.$girls, na.rm = TRUE)} %>% format(big.mark = ",")` were girls, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "3")) %>% {sum(.$men, na.rm = TRUE)} %>% format(big.mark = ",")` were men and  `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "3")) %>% {sum(.$women, na.rm = TRUE)} %>% format(big.mark = ",")` were women. 
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "4")) %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "4")) %>% {sum(.$boys, na.rm = TRUE)} %>% format(big.mark = ",")` were boys and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "4")) %>% {sum(.$girls, na.rm = TRUE)} %>% format(big.mark = ",")` and were girls. 
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "5")) %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "5")) %>% {sum(.$men, na.rm = TRUE)} %>% format(big.mark = ",")` were men and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "5")) %>% {sum(.$women, na.rm = TRUE)} %>% format(big.mark = ",")` and were women. 
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "6")) %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "6")) %>% {sum(.$boys, na.rm = TRUE)} %>% format(big.mark = ",")` were boys and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "6")) %>% {sum(.$girls, na.rm = TRUE)} %>% format(big.mark = ",")` and were girls 
