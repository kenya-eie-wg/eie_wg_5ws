...
A total of `r sum_stats %>% pull(reached_1256) %>% format(big.mark = ",")` persons have been reached by EiE activities in 2023, of which `r sum_stats %>% pull(boys) %>% format(big.mark = ",")` were boys, `r sum_stats %>% pull(girls) %>% format(big.mark = ",")` were girls, `r sum_stats %>% pull(men) %>% format(big.mark = ",")` were men and `r sum_stats %>% pull(women) %>% format(big.mark = ",")`. 

This is a summary by indicator. 
...
eie %>% 
  ...
  labs(x = "Reached", 
       y = "", 
       title = "Reach disaggregated by sex and age", 
       subtitle = "Excludes some incorrect reporting under indicators 5 and 6")
...
### 1. Access to ECD spaces/schools
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "1") & activity_status == "Completed") %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "1") & activity_status == "Completed") %>% {sum(.$boys, na.rm = TRUE)} %>% format(big.mark = ",")` were boys and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "1") & activity_status == "Completed") %>% {sum(.$girls, na.rm = TRUE)} %>% format(big.mark = ",")` were girls.
...
summary_table %>% 
  ...
  flextable() %>% 
  theme_zebra() %>% 
  set_caption(paste0("EiE Indicator 2, as of ", report_date)) %>% 
  set_table_properties(layout = "autofit", width = .99) %>% 
  fontsize(i = 1, j = 1, size = 9) %>% 
  fontsize(size = 9, part = "header") 
```
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "2") & activity_status == "Completed") %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "2") & activity_status == "Completed") %>% {sum(.$boys, na.rm = TRUE)} %>% format(big.mark = ",")` were boys and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "2") & activity_status == "Completed") %>% {sum(.$girls, na.rm = TRUE)} %>% format(big.mark = ",")` were girls. 
...
summary_table %>% 
  ...
  flextable() %>% 
  theme_zebra() %>% 
  set_caption(paste0("EiE Indicator 3, as of ", report_date)) %>% 
  set_table_properties(layout = "autofit", width = .99) %>% 
  fontsize(i = 1, j = 1, size = 9) %>% 
  fontsize(size = 9, part = "header") 
```
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "3") & activity_status == "Completed") %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "3") & activity_status == "Completed") %>% {sum(.$boys, na.rm = TRUE)} %>% format(big.mark = ",")` were boys,  `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "3") & activity_status == "Completed") %>% {sum(.$girls, na.rm = TRUE)} %>% format(big.mark = ",")` were girls, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "3") & activity_status == "Completed") %>% {sum(.$men, na.rm = TRUE)} %>% format(big.mark = ",")` were men and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "3") & activity_status == "Completed") %>% {sum(.$women, na.rm = TRUE)} %>% format(big.mark = ",")` were women. 
...
summary_table %>% 
  ...
  flextable() %>% 
  theme_zebra() %>% 
  set_caption(paste0("EiE Indicator 4, as of ", report_date)) %>% 
  set_table_properties(layout = "autofit", width = .99) %>% 
  fontsize(i = 1, j = 1, size = 9) %>% 
  fontsize(size = 9, part = "header") 
```
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "4") & activity_status == "Completed") %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "4") & activity_status == "Completed") %>% {sum(.$boys, na.rm = TRUE)} %>% format(big.mark = ",")` were boys and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "4") & activity_status == "Completed") %>% {sum(.$girls, na.rm = TRUE)} %>% format(big.mark = ",")` and were girls. 
...
### 5. Educators trained in resilience enhancing programmes
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "5") & activity_status == "Completed") %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "5") & activity_status == "Completed") %>% {sum(.$men, na.rm = TRUE)} %>% format(big.mark = ",")` were men and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "5") & activity_status == "Completed") %>% {sum(.$women, na.rm = TRUE)} %>% format(big.mark = ",")` and were women. 
...
### 6. Children benefited from resilience enhancing programmes
...
In `r report_month` 2023, `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "6") & activity_status == "Completed") %>% {sum(.$total_reached, na.rm = TRUE)} %>% format(big.mark = ",")` persons were reached by interventions contributing to this indicator, of which `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "6") & activity_status == "Completed") %>% {sum(.$boys, na.rm = TRUE)} %>% format(big.mark = ",")` were boys and `r eie %>% filter(month %in% report_month & str_detect(indicator_short, "6") & activity_status == "Completed") %>% {sum(.$girls, na.rm = TRUE)} %>% format(big.mark = ",")` and were girls 
...
## 3.1 Partners' operational presence
...
partner_map <- eie %>% 
  ...
  mutate(reached = men + women + boys + girls, 
         male = men + boys, 
         female = women + girls, 
         male_pc = round(male / reached * 100, digits = 2), 
         female_pc = round(female / reached * 100, digits = 2)) %>% 
  mutate(partners_colour = partners + runif(1, min = -.1, max = .1)) %>% 
...
ggplotly(partner_map, tooltip = c("text")) %>% 
  layout(title = list(text = paste0(sum_stats$partners, " EiE implementing partners across ", sum_stats$counties, " counties",
                                    "<br>",
                                    "<sup>",
                                    "as of ", report_date, "; mouse over county name for more details", "</sup>")))
```
...
Download the dataset below [here](https://github.com/kenya-eie-wg/eie_wg_5ws/blob/main/data/breakdown_by_county_partner.csv). 
...
eie %>% 
  ...
  theme_void() + 
  labs(fill = "% of target", 
       title = "Percentage of overall county target reached") +   
...
eie %>% 
  ...
  flextable() %>% 
  theme_zebra() %>% 
  set_caption("Text of EiE indicators") %>% 
