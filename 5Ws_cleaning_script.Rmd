...
read_5ws_v1 <- function(file) {
  ...
  read_excel(file, 
    ...
    # Note the column here specifying the source, also with a filepath
...
# path_5ws <- "C:/Users/LEGION/Documents/GitHub/eie_wg_5ws/data/5Ws_2023"
...
```{r warning=FALSE}
# path_5ws_v2 <- "C:/Users/LEGION/Documents/GitHub/eie_wg_5ws/data/5Ws_2023_v2"
...
```{r eval=FALSE}
# path_5ws_v3 <- "C:/Users/LEGION/Documents/GitHub/eie_wg_5ws/data/5Ws_2023_v3"
...
eie %>%
filter(month == "December") %>% count(implementing_partner, month, sort = TRUE)
...
partners_raw  <- read_csv("./data/partner_names_raw.csv") %>% 
  ...
  mutate(acronym = case_when(agency_name == "Christian Blind Mission"~ "CBM",
                             ...
                             agency_name == "Lutheran World Federation" ~ "LWF", 
                             TRUE ~ acronym)) %>% 
